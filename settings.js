...
const BOTNAME = 'UsMan-AFriDi|-WA-BOT™';
const FOOTERNAME = '> UsMan -  ＭＤ - Ｖ4';
...
MODERATORS : process.env.MODERATORS === undefined ? "923345511924,923140529832" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '1536': process.env.MAX_SIZE,/*add this in megabytes*/    
OWNER_NAME: process.env.OWNER_NAME || 'UsMan-AFriDi' ,
